...
function launch() {
  ...
  var allItems = '{"products":' + JSON.stringify(sudd).slice(0, -1) + "," + JSON.stringify(merchandise).slice(1, -1) + "," + JSON.stringify(onDisplay).slice(1, -1) + "," + JSON.stringify(individualItems).slice(1) + "}";
