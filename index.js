...
var products;
await fetch("https://johanssuddproducts.herokuapp.com/").then(response=>response.json).then(data=>products = data);
...
var allItems = JSON.parse('{"products":[' + JSON.stringify(sudd).slice(0, -2) + "," + JSON.stringify(merchandise).slice(10) + "," + JSON.stringify(individualItems) + "]}");
