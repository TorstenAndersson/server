...
function launch() {
  ...
  var allItems = '{"products":' + JSON.stringify(sudd).slice(0, -2) + "," + JSON.stringify(merchandise).slice(10) + ',' + JSON.stringify(sudd) + ',' + JSON.stringify(merchandise) + "}," + JSON.stringify(individualItems) + "}";
